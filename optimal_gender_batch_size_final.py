...
# checkpoint = keras.callbacks.ModelCheckpoint(drive_prefix  + '/baseline_checkpoint.h5', monitor='val_accuracy', verbose=1, mode='max',save_best_only = True)
# csv_logger = keras.callbacks.CSVLogger(drive_prefix  + '/baseline_csvlog.csv')
...
for b_size in batch_size:
    ...
    metrics=['accuracy'])
    checkpoint_filepath = "/home/UG/atrik001/best_model_gender_final_"+str(b_size)+"_"+str(learning_rate)+"_"+str(num_neurons)+"_"+str(num_layers)+".tf"
    ...
    path_1="/home/UG/atrik001/data_eval_gender_final_"+str(b_size)+"_"+str(learning_rate)+"_"+str(num_neurons)+"_"+str(num_layers)+".csv"
    ...
    path_2="/home/UG/atrik001/data_gender_scores_final_"+str(b_size)+"_"+str(learning_rate)+"_"+str(num_neurons)+"_"+str(num_layers)+".csv"
