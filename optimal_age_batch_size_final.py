...
df=pd.read_csv('/content/drive/MyDrive/NNDL-Project/fold_frontal_0_data.txt', sep='\t')
df1=pd.read_csv('/content/drive/MyDrive/NNDL-Project/fold_frontal_1_data.txt', sep='\t')
df2=pd.read_csv('/content/drive/MyDrive/NNDL-Project/fold_frontal_2_data.txt', sep='\t')
df3=pd.read_csv('/content/drive/MyDrive/NNDL-Project/fold_frontal_3_data.txt', sep='\t')
df4=pd.read_csv('/content/drive/MyDrive/NNDL-Project/fold_frontal_4_data.txt', sep='\t')

def df_to_list(df):
    data2=[]
    for i in range(len(df)):
        path="/content/drive/MyDrive/NNDL-Project/aligned/"+str(df['user_id'][i])+"/landmark_aligned_face."+str(df['face_id'][i])+"."+str(df['original_image'][i])              
        if df['gender'][i]=='m':
            gender=0
        else:
            gender=1
...
df_new.to_csv("/content/drive/MyDrive/NNDL-Project/CSV file/data_filtered.csv",index=False)
...
for b_size in batch_size:
    ...
    checkpoint_filepath = "/content/drive/MyDrive/NNDL-Project/best_model_age_final_"+str(b_size)+"_"+str(learning_rate)+"_"+str(num_neurons)+"_"+str(num_layers)+".tf"
    ...
    path_1="/content/drive/MyDrive/NNDL-Project/data_eval_age_final_"+str(b_size)+"_"+str(learning_rate)+"_"+str(num_neurons)+"_"+str(num_layers)+".csv"
    ...
    path_2="/content/drive/MyDrive/NNDL-Project/data_age_scores_final_"+str(b_size)+"_"+str(learning_rate)+"_"+str(num_neurons)+"_"+str(num_layers)+".csv"
