# -*- coding: utf-8 -*-
"""Finetuning Gender.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18COaL0KUua6qOO6eDks9zVNlaGUHSSBq
"""
...
checkpoint_filepath = "/home/UG/atrik001/pretrained models/pretrained_checkpoint_age.h5"
...
transfer_model.compile(loss=loss_func, optimizer=sgd, metrics=['accuracy'])
...
drive_prefix = "/home/UG/atrik001/finetuned models"
checkpoint = keras.callbacks.ModelCheckpoint(
    drive_prefix + '/finetuned_age_checkpoint.h5', monitor='val_accuracy', verbose=1, mode='max', save_best_only=True)
csv_logger = keras.callbacks.CSVLogger(
    drive_prefix + '/finetuned_age_csvlog.csv')
...
# Train the model
results = transfer_model.fit(x_train, y_train,
...
drive_prefix = "/home/UG/atrik001/finetuned models"
checkpoint = keras.callbacks.ModelCheckpoint(
    drive_prefix + '/finetuned_checkpoint_age_final.h5', monitor='val_accuracy', verbose=1, mode='max', save_best_only=True)
csv_logger = keras.callbacks.CSVLogger(
    drive_prefix + '/finetuned_csvlog_age_final.csv')
early_stopping = keras.callbacks.EarlyStopping(monitor='val_loss', patience=10)
if save_model:
    callbacks = [lrate, checkpoint, csv_logger, early_stopping]
else:
