...
checkpoint_filepath = "/home/UG/kamakshi001/baseline_gender_celebA_pretraining_checkpoint.tf"
...
drive_prefix = "/home/UG/kamakshi001/finetuned models"
checkpoint = keras.callbacks.ModelCheckpoint(
    drive_prefix + '/finetuned_gender_checkpoint.h5', monitor='val_accuracy', verbose=1, mode='max', save_best_only=True)
csv_logger = keras.callbacks.CSVLogger(
    drive_prefix + '/finetuned_gender_csvlog.csv')
...
drive_prefix = "/home/UG/kamakshi001/finetuned models"
checkpoint = keras.callbacks.ModelCheckpoint(
    drive_prefix + '/finetuned_gender_checkpoint_final.h5', monitor='val_accuracy', verbose=1, mode='max', save_best_only=True)
csv_logger = keras.callbacks.CSVLogger(
    drive_prefix + '/finetuned_gender_csvlog_final.csv')
early_stopping = keras.callbacks.EarlyStopping(monitor='val_loss', patience=10)
if save_model:
    callbacks = [lrate, checkpoint, csv_logger, early_stopping]
else:
