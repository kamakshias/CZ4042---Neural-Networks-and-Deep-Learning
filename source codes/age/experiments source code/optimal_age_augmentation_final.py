...
# Augmentation layer initialization
...
checkpoint = keras.callbacks.ModelCheckpoint(
    drive_prefix + '/augmentation_checkpoint_age.h5', monitor='val_accuracy', verbose=1, mode='max', save_best_only=True)
csv_logger = keras.callbacks.CSVLogger(
    drive_prefix + '/augmentation_csvlog_age.csv')
