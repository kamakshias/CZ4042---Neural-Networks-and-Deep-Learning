...
model.add(keras.layers.Conv2D(96, (7,7),input_shape=(256,256,3),strides=4,padding='valid',activation='relu',kernel_initializer=weight_init))
...
model.add(keras.layers.Dropout(0.5))
#FC3
model.add(keras.layers.Dense(1,activation ='sigmoid',kernel_initializer=weight_init))
