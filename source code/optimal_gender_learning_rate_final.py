...
from tensorflow.keras.layers import Dense, Conv2D, MaxPooling2D, Flatten, Dropout, Lambda
...
x_train, y_train, x_val, y_val, x_test, y_test = df_image_x[0:9492], df_gender_y[0:9492], df_image_x[
...
for learning_rate in learning_rates:
    ...
    checkpoint_filepath = "/home/UG/atrik001/best_model_gender_" + \
    ...
    path_1 = "/home/UG/atrik001/data_eval_gender_final_" + \
        str(batch_size)+"_"+str(learning_rate)+"_" + \
    ...
    path_2 = "/home/UG/atrik001/data_gender_scores_final_" + \
        str(batch_size)+"_"+str(learning_rate)+"_" + \
        str(num_neurons)+"_"+str(num_layers)+".csv"
