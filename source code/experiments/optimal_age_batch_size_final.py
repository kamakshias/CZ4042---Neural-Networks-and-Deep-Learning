...
for b_size in batch_size:
    ...
    checkpoint_filepath = "/home/UG/kamakshi001/best_model_age_final_"+str(b_size)+"_"+str(learning_rate)+"_"+str(num_neurons)+"_"+str(num_layers)+".tf"
    ...
    path_1="/home/UG/kamakshi001/data_eval_age_final_"+str(b_size)+"_"+str(learning_rate)+"_"+str(num_neurons)+"_"+str(num_layers)+".csv"
    ...
    path_2="/home/UG/kamakshi001/data_age_scores_final_"+str(b_size)+"_"+str(learning_rate)+"_"+str(num_neurons)+"_"+str(num_layers)+".csv"
