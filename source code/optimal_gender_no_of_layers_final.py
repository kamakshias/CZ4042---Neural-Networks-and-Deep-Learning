...
# # Experimenting with number of layers [3,4,5] with:
# ## 1) Number of neurons = 256 [optimal]
...
x_train, y_train, x_val, y_val, x_test, y_test = df_image_x[0:9492],df_age_y[0:9492],df_image_x[9492:11527],df_age_y[9492:11527],df_image_x[11527:13561],df_age_y[11527:13561]
...
# # Strating Training with 1 hidden Layer
...
# # Strating Training with 2 Layers
...
# # Strating Training with 3 Layers
